...
const ALL_STATS_PROCEDURE_MONTH = `
  SELECT
      ...
      SUM(IF(h_numeroProcedure = 1, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "N.D", 
      SUM(IF(h_numeroProcedure = 2, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "C.E.L", 
      SUM(IF(h_numeroProcedure = 3, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "2nd.R", 
      SUM(IF(h_numeroProcedure = 4, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "D.A.S", 
      SUM(IF(h_numeroProcedure = 5, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "I.M", 
      SUM(IF(h_numeroProcedure = 6, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "BORNAGE", 
      SUM(IF(h_numeroProcedure = 7, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "REMISE", 
      SUM(IF(h_numeroProcedure = 8, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "F.L.C", 
      SUM(IF(h_numeroProcedure = 9, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "DECOMPTE", 
      SUM(IF(h_numeroProcedure = 10, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "P.A.V", 
      SUM(IF(h_numeroProcedure = 11, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "MUTATION", 
      SUM(IF(h_numeroProcedure = 69, DATEDIFF(dateFinMouvement, dateDebutMouvement), NULL)) as "AVC"
  FROM
      HISTORIQUE
  GROUP BY
