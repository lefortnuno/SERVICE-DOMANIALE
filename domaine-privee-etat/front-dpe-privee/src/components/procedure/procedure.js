...
export default function Procedure() {
  ...
  const showDeleteModal = (id) => {
    setId(id);
    setDeleteMessage(
      `Etes vous sûre de vouloir supprimer l'Procedure : 
        ...
        <div>
          ...
          <label>
            <input
              ...
              placeholder="rechercher un Procedure ...."
              autoComplete="off"
            />
          </label>
        </div>
          ...
          <table className="table table-striped w-auto">
            <thead>
              <tr>
                ...
                <th scope="col">Nom du Procedure</th>
            ...
            <tbody>
              {contenuTab ? (
                currentItems.map((user, key) => (
                  <tr key={key}>
                    <th scope="row">{user.numProcedure}</th>
                    ...
                    <td>
                      <button
                        ...
                        variant="default"
                        name="numCompteEdit"
                        onClick={() => showEditModal(user.numProcedure)}
                      >
                        <BsEye />
                      </button>
                      ...
                      <button
                        ...
                        variant="default"
                        name="numCompteEdit"
                        onClick={() => showEditModal(user.idBureau)}
                      >
                        <BsPencilSquare />
                      </button>
                      ...
                      <Button
                        ...
                        variant="default"
                        onClick={() => showDeleteModal(user.numProcedure)}
                      >
                        <BsFillTrashFill />
                      </Button>
                    </td>
